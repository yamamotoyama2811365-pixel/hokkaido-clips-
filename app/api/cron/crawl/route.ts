...
export async function GET() {
  ...
  const SEARCH_TARGETS = [
    ...
    // 札幌グルメ（細分化して被りを防止）
    { query: '札幌 ジンギスカン 有名店', genre: 'gourmet', area: '札幌' },
    { query: '札幌 スープカレー 行列', genre: 'gourmet', area: '札幌' },
    { query: '札幌 味噌ラーメン 観光', genre: 'gourmet', area: '札幌' },
    { query: '札幌 シメパフェ 夜パフェ', genre: 'gourmet', area: '札幌' },
    { query: '札幌 海鮮丼 朝市 グルメ', genre: 'gourmet', area: '札幌' },

          ...
          <div ref={blogSectionRef} className="space-y-4 bg-slate-900/95 border border-teal-500/40 p-5 rounded-2xl shadow-xl">
            ...
            <div className="space-y-3">
              {displayedBlogPosts.map((post) => {
                ...
                // 各記事の独立した個別ページURLへ遷移する（slugまたはidを使用）
                ...
                return (
                  <div 
                    ...
                    className="group bg-slate-950 border border-slate-800 hover:border-teal-500 rounded-xl p-3 flex items-center justify-between gap-4 transition cursor-pointer"
                  >
